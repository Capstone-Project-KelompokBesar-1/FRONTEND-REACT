    ...
    <div className="ml-[292px] pt-[124px] mr-9">
      <div>
        ...
        <div className="border rounded-2xl px-4 py-6">
          ...
          <div className="flex w-full h-12 justify-start pl-[118px] items-center font-avenirHeavy mb-2 bg-primary-100">
            <label htmlFor="status">Detail Kelas</label>
          </div>
          <div className='flex flex-row'>
            <div>
              <div className="flex w-52 h-12 justify-end items-center font-avenirHeavy mb-2">
                <label htmlFor="status">Jenis Kelas</label>
              </div>
              <div className="flex w-52 h-12 justify-end items-center font-avenirHeavy mb-2">
                <label htmlFor="status">Nama Kelas</label>
              </div>
              <div className="flex w-52 h-12 justify-end items-center font-avenirHeavy mb-2">
                <label htmlFor="status">Harga Kelas</label>
              </div>
            </div>
            <div>
            <select
